...
class DarkNet(object):
    ...
    def build(self, input_image, data_format, dropout_keep_prob, trainable=True):
        ...
        x = MaxPool(x, 2, data_format, name="maxpool1_26to13")
